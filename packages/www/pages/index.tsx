    ...
    return (
        <>
            ...
            <Layout>
                ...
                <section className="text-center pt-20 pb-20 md:pt-5 relative">
                    <Container>
                ...
                <section className="text-center py-20">
                    <Container>
                        <div className="px-5 md:px-12 py-10">
                            ...
                            <h2 className="text-dark-blue font-bold text-2xl pb-5">Quality benchmarks for sensitive data</h2>
                            <p className="pb-10">
                        ...
                        <div className="px-5 md:px-12 py-10">
                            ...
                            <h2 className="text-dark-blue font-bold text-2xl pb-5">Data is never disclosed</h2>
                            <p className="pb-10">
                ...
                <section className="text-center bg-light-blue py-20 relative">
                    <Container>
                        <div>
                            <img alt="" src={backdropLogo} className="absolute z-0" style={{
                                right: '-50%'
                            ...
                            <div className="relative pb-32 z-10">
                                ...
                                <div className="flex flex-wrap md:flex-no-wrap gap-5 md:px-40">
                                    <div className="w-full md:w-1/3">
                                        <img alt="" src={semPointA} className="pb-3" style={{
                                            height: '6rem'
                                        }} />
                                        <span><b>KYC and AML</b> data collaboration</span>
                                    </div>
                                    <div className="w-full md:w-1/3">
                                        <img alt="" src={semPointB} className="pb-3" style={{
                                            height: '6rem'
                                        }} />
                                        <span>Signals <b>KYC anomalies</b></span>
                                    </div>
                                    <div className="w-full md:w-1/3">
                                        <img alt="" src={semPointC} className="pb-3" style={{
                                            height: '6rem'
                                        }} />
                            ...
                            <div className="relative pb-32 z-10">
                                ...
                                <div className="flex flex-wrap md:flex-no-wrap gap-5 md:px-40">
                                    <div className="w-full md:w-1/3">
                                        <img alt="" src={daPointA} className="pb-3" style={{
                                            height: '6rem'
                                        }} />
                                        <span>Currently compares <b>24 client reference data attributes</b></span>
                                    </div>
                                    <div className="w-full md:w-1/3">
                                        <img alt="" src={daPointB} className="pb-3" style={{
                                            height: '6rem'
                                        }} />
                                        <span><b>Client reference</b> data collaboration</span>
                                    </div>
                                    <div className="w-full md:w-1/3">
                                        <img alt="" src={daPointC} className="pb-3" style={{
                                            height: '6rem'
                                        }} />
                ...
                <section className="text-center md:text-left py-20 relative">
                    <Container>
                        <img alt="" src={backdropLogo} className="absolute z-0" style={{
                            left: '-50%'
                        }} />
